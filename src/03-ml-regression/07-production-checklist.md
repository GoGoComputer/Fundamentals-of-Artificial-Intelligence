...
> 회귀 특유의 함정들이 있어요. 분류와 같은 것들은 [2장 8절](../02-ml-classification/08-production-checklist.md)을 참고하시고, 이 글은 **회귀에서만 신경 써야 할 것들** 위주로 다룹니다.
...
➡️ **[4장. 딥러닝 — 분류](../04-dl-classification/README.md)**
