...
> ML 체크리스트([2.8](../02-ml-classification/08-production-checklist.md))는 딥러닝에도 거의 다 적용돼요.
...
[5장](../05-dl-regression/README.md)에서 자세히 다룹니다.
...
[GPU 활용](06-gpu.md)에서 봤죠. 큰 모델 학습할 땐 거의 표준이에요.
...
➡️ **[5장. 딥러닝 — 회귀](../05-dl-regression/README.md)**
